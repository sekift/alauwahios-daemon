...
public class KuwoDao {
	...
	public static boolean saveKuwoSingerTotal(String prefix, Object total, String remark) {
		...
		String sql = "INSERT INTO que_singer_total(prefix,total,createTime,updateTime,remark)"
		...
		try {
			result = DBOperate.update(Constants.QUELILI_MASTER, sql, params.toArray()) > 0;
		} catch (Exception e) {
	...
	public static int getKuwoSingerTotal(String prefix){
		String sql = "SELECT total FROM que_singer_total WHERE prefix=?";
		int total = (Integer) DBOperate.query4ObjectQuietly(Constants.QUELILI_SLAVE, sql, prefix);
		return total;
	}
	...
	public static int getKuwoSingerNum(int artistId){
		String sql = "select count(*) from que_singer_info where artistId<?;";
		Long total = (Long) DBOperate.query4ObjectQuietly(Constants.QUELILI_SLAVE, sql, artistId);
	...
	public static List<KuwoSingerInfoVO> getKuwoSingerInfo(int beginId, int endId){
		String sql = "SELECT artistId,artistName,albumNum,musicNum FROM que_singer_info ORDER BY artistId asc LIMIT ?,?";
		List<KuwoSingerInfoVO> list = (List<KuwoSingerInfoVO>) DBOperate.queryQuietly(Constants.QUELILI_SLAVE, sql,
	...
	public static List<Object> getKuwoSingerId(){
		String sql = "SELECT artistId FROM que_singer_base";
		List<Object> list = (List<Object>) DBOperate.queryQuietly(Constants.QUELILI_SLAVE, sql,
	...
	public static boolean saveKuwoSingerName(KuwoSingerNameVO vo) {
		...
		String sql = "INSERT INTO que_singer_name(artistId,artistName,"
	...
	public static boolean saveKuwoSingerBase(KuwoSingerBaseVO vo) {
		...
		String sql = "INSERT INTO que_singer_base(artistId,aartist,"
	...
	public static boolean saveKuwoSingerInfo(KuwoSingerInfoVO vo) {
		...
		String sql = "INSERT INTO que_singer_info(artistId,aartist,"
	 ...
	 * @param args
	 */
	public static boolean getKuwoMusicExists(int musicId){
		String sql = "SELECT * FROM que_music WHERE musicId=?";
		KuwoMusicVO vo = (KuwoMusicVO) DBOperate.queryQuietly(Constants.QUELILI_SLAVE, sql,new BeanHandler(KuwoMusicVO.class), musicId);
		boolean flag = false;
		if(null!=vo){
			flag = true;
		}
	...
	public static boolean saveKuwoMusic(KuwoMusicVO vo) {
		...
		String sql = "INSERT INTO que_music("
	...
	// 歌词数据库名称
	public static final String QUE_LYRIC_NAME = "que_lyric";
	public static final String QUE_LYRIC_NAME_NONE = "que_lyric_none";
	...
	public static boolean getKuwoLyricExists(int musicId){
		String sql = "SELECT * FROM "+QUE_LYRIC_NAME+" WHERE musicId=?";
		KuwoLyricVO vo = (KuwoLyricVO) DBOperate.queryQuietly(Constants.QUELILI_SLAVE, sql,new BeanHandler(KuwoLyricVO.class), musicId);
		boolean flag = false;
		if(null!=vo){
			flag = true;
		}
	 ...
	 * @param args
	 */
	public static boolean getKuwoLyricNoneExists(int musicId){
		String sql = "SELECT * FROM "+QUE_LYRIC_NAME_NONE+" WHERE musicId=?";
		KuwoLyricVO vo = (KuwoLyricVO) DBOperate.queryQuietly(Constants.QUELILI_SLAVE, sql,new BeanHandler(KuwoLyricVO.class), musicId);
		boolean flag = false;
		if(null!=vo){
			flag = true;
	...
	public static boolean saveKuwoLyric(KuwoLyricVO vo) {
		...
		String sql = "INSERT INTO "+QUE_LYRIC_NAME+"("
	 ...
	 * @return
	 */
	public static boolean saveKuwoLyricNone(KuwoLyricVO vo) {
		boolean result = false;
		if (null == vo) {
			return result;
		}
		String sql = "INSERT INTO "+QUE_LYRIC_NAME_NONE+"("
				+ " musicId,musicName,albumId,albumName,artistId,artistName,"
				+ " lrcList,nsig1,nsig2,score100,playCnt,"
				+ " curUrl,createTime,updateTime,remark)"
				+ " VALUES(?,?,?,?,?,?,?,?,?,?,?,?,now(),now(),?)"
	...
	public static boolean saveKuwoAlbum(KuwoAlbumVO vo) {
		...
		String sql = "INSERT INTO que_album(albumId,albumName,artistId,"
	 ...
	 * @param args
	 */
	public static boolean getKuwoAlbumExists(int albumId){
		String sql = "SELECT * FROM que_album WHERE albumId=?";
		KuwoAlbumVO vo = (KuwoAlbumVO) DBOperate.queryQuietly(Constants.QUELILI_SLAVE, sql,new BeanHandler(KuwoAlbumVO.class), albumId);
		boolean flag = false;
		if(null!=vo){
			flag = true;
		}
...
//		System.out.println(getKuwoLyricExists(54316));
		System.out.println(getKuwoAlbumExists(54316));
